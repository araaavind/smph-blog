...
import 'package:semaphore/core/utils/pick_image.dart';
...
import 'package:semaphore/features/blog/presentation/widgets/blog_editor.dart';

class AddBlogNewPage extends StatefulWidget {
  static route() => MaterialPageRoute(
        builder: (context) => const AddBlogNewPage(),
      );

  const AddBlogNewPage({super.key});

  @override
  State<AddBlogNewPage> createState() => _AddBlogNewPageState();
}

class _AddBlogNewPageState extends State<AddBlogNewPage> {
